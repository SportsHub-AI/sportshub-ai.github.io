...
{{< section-container class="bg-gradient-to-b from-blue-50 via-blue-50 to-white pt-20 pb-24" >}}
  ...
  <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-md p-8 text-gray-800">
    ...
    <p class="mb-4">Room 423, Building 1, Bronze Technologies Building, No.6 Guangke 1st Road, Laokeng Community, Longtian Subdistrict, Pingshan District, Shenzhen</p>

    <h2 class="text-2xl font-semibold mt-8 mb-4">Contact Details</h2>
    <ul class="space-y-2">
      <li>📞 Phone: <a href="tel:your-phone-number" class="text-blue-600 hover:underline">+86 156 8223 9906</a></li>
